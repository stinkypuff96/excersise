...
def get_answer(question_text, prompt, valid_choices):       # function to streamline user choice restrictions
    while True:
        print(question_text)
        answer = input(prompt)
...
while True:
    ...
    difficulty = ("Choose difficulty(Easy/Normal/Hard) or write 'quit' to quit.")
    difficulty_choice = get_answer(difficulty, 'Choice: ', ['easy', 'normal', 'hard', 'quit']).lower()
